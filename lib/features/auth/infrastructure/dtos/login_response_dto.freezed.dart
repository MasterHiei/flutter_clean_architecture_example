...
/// Access token for API authorization
 String get accessToken;/// Refresh token for obtaining new access tokens
 String get refreshToken;/// Token lifetime in seconds
...
@override
String toString() {
  return 'LoginResponseDto(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn, tokenType: $tokenType)';
}
...
class _LoginResponseDto implements LoginResponseDto {
  const _LoginResponseDto({required this.accessToken, required this.refreshToken, required this.expiresIn, this.tokenType = 'Bearer'});
